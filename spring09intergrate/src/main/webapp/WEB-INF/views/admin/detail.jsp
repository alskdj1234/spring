...
<li>아이디 : ${everyInfo.memberId}</li>
	...
	<c:if test="${everyInfo.isWaitForDelete()}">
...
<h2><a href="./block?memberId=${everyInfo.memberId}">${everyInfo.memberBlock== 'y' ? '해제' : '차단' }</a></h2>
<h2><a href="./edit?memberId=${everyInfo.memberId}">${everyInfo.memberId}의 정보 변경</a></h2>
