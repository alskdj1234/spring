...
=======
Email <input type="text" inputmode="email" name="memberEmail" required><br> <!--  inputmode:입력방식 -->
비밀번호<input type="password" name="memberPassword" required><br>
닉네임 <input type="text" name="memberNickname" required><br>
생년월일 <input type="text" inputmode="numeric" name="memberBirth"><br>
연락처 <input type="text" inputmode="tel" name="memberContact" required><br>
<h2>주소입력시 우편번호, 기본주소, 상세주소를 모두 입력 해 주세요</h2><br>
우편번호 <input type="text" inputmode="numeric" name="memberPost"><br>
기본주소 <input type="text" name="memberAddress1"><br>
상세주소 <input type="text" name="memberAddress2"><br>
상태 메시지 
