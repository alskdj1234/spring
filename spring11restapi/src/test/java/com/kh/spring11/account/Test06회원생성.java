		 ...
		 for (int i = 1; i <= 1000; i++) {
		        try {
		            AccountDto accountDto = AccountDto.builder()
		                    ...
		                    .accountPost(
		                            randomService.generateNumber(r.nextInt(2) + 5)
		                    )
		                    .accountAddress1(
		                            addrList.get(r.nextInt(addrList.size()))
		                    )
		                    .accountAddress2(
		                            "000아파트" + (i * i) + "동" + i + "호"
		                    )
		            ...
		            System.out.println(i + "번 회원 생성 완료");
		        }
		        catch (Exception e) {
		            System.err.println(i + "번 회원 생성 실패");
		            System.err.println("아이디: dummyuser" + i);
		            e.printStackTrace();
		            break;
		        }
		    }
