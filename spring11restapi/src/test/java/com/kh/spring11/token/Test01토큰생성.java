...
public class Test01토큰생성 {
	...
	public void test() {
		//JWT (JSON Web Token)
		//1. 암호화를 위한 알고리즘과 key를 설정
		//2. 토큰 본체를 생성 (원하는 정보를 추가)
		//3. 최종 토큰 생성
		
		//1.
		String secret = "123456789012345678901234567890123456789012";//암호화/복호화에 사용할 열쇠 (외부 노출 금지) - 32byte이상을 권장
		//사용 알고리즘을 지정해 실제 암호화용 키로 변환
		...
		JwtClaimsSet claims = JwtClaimsSet.builder()
				...
				.expiresAt(current.plusSeconds(60L))//만료시각
